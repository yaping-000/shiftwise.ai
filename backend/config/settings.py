...
FORCE_SCRIPT_NAME = ''  # Ensure Django knows it's at the root
STATIC_URL = '/static/'  # Explicit static URL with leading slash
MEDIA_URL = '/media/'   # Explicit media URL with leading slash
